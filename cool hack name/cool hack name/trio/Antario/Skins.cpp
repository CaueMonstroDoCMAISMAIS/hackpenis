	...
	for (int i = 0; hweapons[i] != INVALID_EHANDLE_INDEX; i++)
	{
		...
		if (pWeapon->IsKnife(pWeapon->GetCSWeaponData()))
		{
			...
			case MenuKnife::Bowei:
				pWeapon->m_Item().m_iItemDefinitionIndex() = ItemDefinitionIndex::WEAPON_KNIFE_SURVIVAL_BOWIE;
				...
				pWeapon->m_nFallbackPaintKit() = g_Options.W[ItemDefinitionIndex::WEAPON_KNIFE_SURVIVAL_BOWIE].ChangerSkin;
				pWeapon->m_flFallbackWear() = 0.001f;
				pWeapon->m_Item().m_iItemIDHigh() = -1;
				break;
			...
			case MenuKnife::Hunts:
				pWeapon->m_Item().m_iItemDefinitionIndex() = ItemDefinitionIndex::WEAPON_KNIFE_TACTICAL;
				...
				pWeapon->m_nFallbackPaintKit() = g_Options.W[ItemDefinitionIndex::WEAPON_KNIFE_TACTICAL].ChangerSkin;
				pWeapon->m_flFallbackWear() = 0.001f;
				pWeapon->m_Item().m_iItemIDHigh() = -1;
				break;
			case MenuKnife::Karam:
			...
			case MenuKnife::M9:
				...
				pWeapon->m_nFallbackPaintKit() = g_Options.W[ItemDefinitionIndex::WEAPON_KNIFE_M9_BAYONET].ChangerSkin;
				pWeapon->m_flFallbackWear() = 0.001f;
				pWeapon->m_Item().m_iItemIDHigh() = -1;
				break;
			...
			if (g_Options.skins_knife_model)
			{
				...
				else if (pk == 582 && index == WEAPON_KNIFE_M9_BAYONET)
					pWeapon->m_nFallbackPaintKit() = 581;
				else if (pk == 578 && index == WEAPON_KNIFE_M9_BAYONET)
